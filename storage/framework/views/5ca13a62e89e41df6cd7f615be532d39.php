...
<body>
    <div class="card">
        <div class="top-buttons">
            <a href="<?php echo e(route('admin.urls')); ?>" class="btn-secondary">Go to Admin</a>
        </div>
        <h1>URL Shortener</h1>
        <p class="muted">Paste a long URL, get something like <code><?php echo e(url('abc123')); ?></code>.</p>

        <form action="<?php echo e(route('shorten.url.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php /**PATH G:\New folder\url-shortener\resources\views/shorten-url.blade.php ENDPATH**/ ?>